...
public class Activity_Challenge_Create extends AppCompatActivity {

    private static final String TAG = Activity_Challenge_Create.class.getSimpleName();
    ...
    Boolean bol_my_challenge_team_1_is_select, bol_my_challenge_team_2_is_select, bol_opponent_challenge_team_1_is_select, bol_opponent_challenge_team_2_is_select;
...
//        txt_user_name = (TextView) findViewById(R.id.challenge_view_txt_name);
        ...
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Activity_Challenge_Create.this, MainActivity.class);
...
//        get notification count
        ...
        try{
            ...
            dialog_notification = new SpotsDialog(Activity_Challenge_Create.this);
        ...
        btn_opponent_challenge_team_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (challenger_teamA_percentage.equals("100")) // means win
                {
                    ...
                    TastyToast.makeText(Activity_Challenge_Create.this, "Can't Choose This, Opponent Already Choosed It.", TastyToast.LENGTH_SHORT, TastyToast.ERROR);
            ...
            public void onClick(View v) {
                ...
                if (str_challenge_type.equals("Cricket")) {
                    ...
                    if (str_op_team_a_percent.equals("")) {
                        ...
                        try {
                            dialog = new SpotsDialog(Activity_Challenge_Create.this);
                            dialog.setCancelable(false);
                            dialog.show();
                            queue = Volley.newRequestQueue(Activity_Challenge_Create.this);
                            Function_Challenge();
                        } catch (Exception e) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_user_profile) {
            ...
            SharedPreferences sharedPreferences = PreferenceManager
                    .getDefaultSharedPreferences(Activity_Challenge_Create.this);
...
//                                txt_user_name.setText("" + str_challenger_name);
                                ...
                                * *****************************************************/
                                ...
                                {
                                    txt_my_name.setText("" + str_name);
                                    Picasso.with(Activity_Challenge_Create.this).
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        new AlertDialog.Builder(Activity_Challenge_Create.this)
...
//                TastyToast.makeText(getApplicationContext(), "Internal Error !", TastyToast.LENGTH_SHORT, TastyToast.ERROR);
            ...
            protected Map<String, String> getParams() {
                ...
                if (match_type.equals("1") || match_type.equals("2")) // cricket
                {
                    ...
                    System.out.println("### str_op_team_a_percent : " + str_op_team_a_percent);
                    System.out.println("### str_op_team_b_percent : " + str_op_team_b_percent);
                } else if (match_type.equals("3") || match_type.equals("4")) { // stock

                    params.put("opponent_points", str_op_share_point);

                    System.out.println("### str_op_share_point : " + str_op_share_point);
                }
